...
namespace stok_.classes.sql_classes
{
    class User_repo : Db_helper
    {
        ...
        {
            string query = "INSERT INTO users(user_name, user_surname, role_id, password) " +
        ...
        {
            string query = "UPDATE users SET user_name = @newName, user_surname = @newSurname, role_id = @newRoleId, " +
